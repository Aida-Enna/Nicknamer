...
namespace Veda
{
    public class Functions
    {
        ...
        public static void WriteJSON<T>(string JSONName, T JSONData)
        {
            File.WriteAllText(JSONName, JsonConvert.SerializeObject(JSONData, Newtonsoft.Json.Formatting.Indented));
        }

        public static T ReadJSON<T>(string JSONName)
        {
            return JsonConvert.DeserializeObject<T>(File.ReadAllText(JSONName));
        }
    }
}